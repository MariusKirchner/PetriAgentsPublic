...
to updateView 
	 ask patches [ 
	 	 if (patch_Meat = 0) [set pcolor 5] 
	 	 if (patch_Meat > 0) [set pcolor 19] 
	 	 if (patch_Meat > 25) [set pcolor 18] 
	 	 if (patch_Meat > 50) [set pcolor 17] 
	 	 if (patch_Meat > 75) [set pcolor 16] 
	 	 if (patch_Meat > 100) [set pcolor 15] 
	 ] 
end 
