...
def saveProject(mainProject, filehandler):
    ...
    molOutFlowBool = doc.createElement("molOutFlow")
    settings.appendChild(molOutFlowBool)
    molOutFlowBool.appendChild(doc.createTextNode(str(mainProject.moleculeOutFlow)))
    bacOutFlowBool = doc.createElement("bacOutFlow")
    settings.appendChild(bacOutFlowBool)
